...
const ViewClaims: React.FC = () => {
  ...
  // Filter claims whenever dates or claims change
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col pb-10 px-4">
      ...
      <div className="mt-28 mb-4 flex flex-col gap-4 w-full">

  {/* Date Filter Card */}
  <div className="bg-white rounded-xl shadow p-4 border border-gray-200 w-full max-w-sm">
    <h4 className="font-semibold text-[#1ebac1] mb-2">Filter by Date</h4>
    ...
    <button
      onClick={handleReset}
      className="bg-[#1ebac1] text-white px-3 py-1 rounded-xl text-sm hover:bg-gray-400 mt-4" >
      Reset
    </button>
  </div>
