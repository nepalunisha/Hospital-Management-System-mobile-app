...
const StaffDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f0f7ff] to-[#e0f0ff] flex flex-col items-center p-4">
      ...
      {/* Patient Selection */}
      <div className="w-70 min-h-md mt-6 flex flex-col items-center gap-2">
        {!selectedPatient ? (
          ...
          <div className="w-full p-3 border border-[#1ebac1] rounded-lg shadow-md bg-white space-y-1">
         ...
         {/* Billing Dates */}
        <div className="w-full max-w-md mt-6 flex justify-center gap-6">
          {/* Start Date */}
          <div className="flex flex-col items-center">
            <p className="text-xs text-[#1ebac1] mb-1 font-semibold text-center"> Billing Start Date (BS)</p>
            <div className="relative w-32 overflow-visible">
              <NepaliDatePicker
                inputClassName="w-full h-10 text-sm border border-[#1ebac1] rounded-md shadow px-2 text-left bg-white cursor-pointer"
                value={startDate}
          ...
          {/* End Date */}
          <div className="flex flex-col items-center">
            <p className="text-xs text-[#1ebac1] mb-1 font-semibold text-center">Billing End Date (BS)</p>
            <div className="relative w-32 overflow-visible">
              <NepaliDatePicker
                inputClassName="w-full h-10 text-sm border border-[#1ebac1] rounded-md shadow px-2 text-left bg-white cursor-pointer"
                value={endDate}
        ...
        <div className="w-full max-w-md mt-6">
          <Button
            className="w-full bg-[#1ebac1] py-3 text-white text-base font-semibold rounded-lg shadow-md hover:scale-105 transition-transform"
